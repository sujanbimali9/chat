      ...
      child: DefaultTextStyle(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text(AuthConstant.password),
            const SizedBox(height: 8),
            ...
            const SizedBox(height: 10),
            const Text(AuthConstant.fullName),
            const SizedBox(height: 8),
            TextFormField(
              controller: name,
            ...
            const SizedBox(height: 10),
            const Text(AuthConstant.phoneNumber),
            const SizedBox(height: 8),
            TextFormField(
