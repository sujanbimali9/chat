...
abstract class _GetAllUser implements UserEvent {
...
/// @nodoc
class __$$GetAllUserLocalImplCopyWithImpl<$Res>
...
class _$GetAllUserLocalImpl implements _GetAllUserLocal {
  const _$GetAllUserLocalImpl();

  @override
  String toString() {
    return 'UserEvent.getAllUserLocal()';
  }

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is _$GetAllUserLocalImpl);
  }
  ...
  TResult? mapOrNull<TResult extends Object?>({
    ...
    return getAllUserLocal?.call(this);
  }
...
abstract class _GetAllUserLocal implements UserEvent {
  const factory _GetAllUserLocal() = _$GetAllUserLocalImpl;
}
...
class _$FetchMoreUserImpl implements _FetchMoreUser {
  ...
  @override
  String toString() {
    return 'UserEvent.fetchMoreUser()';
  }
...
abstract class _FetchMoreUser implements UserEvent {
...
abstract class _RefreshUser implements UserEvent {
...
class _$SearchedUserImpl implements _SearchedUser {
  ...
  List<User> get searchUser {
    if (_searchUser is EqualUnmodifiableListView) return _searchUser;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(_searchUser);
  }
  ...
  @override
  String toString() {
    return 'UserState.searchedUser(searchUser: $searchUser, allUser: $allUser)';
  }
  ...
  TResult when<TResult extends Object?>({
    ...
    return searchedUser(searchUser, allUser);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return searchedUser?.call(searchUser, allUser);
  }
...
class _$LocalUserImpl implements _LocalUser {
  const _$LocalUserImpl(final List<User> users) : _users = users;
...
abstract class _LocalUser implements UserState {
  const factory _LocalUser(final List<User> users) = _$LocalUserImpl;
...
class _$FetchingMoreImpl implements _FetchingMore {
  ...
  @override
  String toString() {
    return 'UserState.fetchingMore(users: $users)';
  }
...
abstract class _FetchingMore implements UserState {
