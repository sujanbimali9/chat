...
class SendTextUseCase implements UseCase<Chat, Chat> {
  final ChatRepository _chatRepository;

  SendTextUseCase(ChatRepository chatRepository)
      : _chatRepository = chatRepository;
  @override
  Future<Either<Failure, Chat>> call(Chat parm) async {
    return await _chatRepository.sendText(ChatModel.fromChat(parm));
  }
}
