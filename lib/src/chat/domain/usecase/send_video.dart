...
class SendVideoUseCase implements UseCase<Chat, Chat> {
  final ChatRepository _chatRepository;

  SendVideoUseCase(ChatRepository chatRepository)
      : _chatRepository = chatRepository;

  @override
  Future<Either<Failure, Chat>> call(Chat parm) async {
    return await _chatRepository.sendVideo(ChatModel.fromChat(parm));
  }
}
